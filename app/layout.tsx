...
export const metadata: Metadata = {
  title: { default: "AI Agents First -- The Living AI Intelligence Hub", template: "%s | AI Agents First" },
  description: "Real-time AI agent intelligence, tutorials, build guides, and curated resources. The internet became conscious.",
