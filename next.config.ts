...
const securityHeaders = [
  ...
  { key: "Permissions-Policy", value: "camera=(), microphone=(), geolocation=()" },
  {
    ...
    value: [
      "default-src 'self'",
      "script-src 'self' 'unsafe-inline' https://aiagentsfirst.com https://va.vercel-scripts.com",
      "style-src 'self' 'unsafe-inline'",
      "img-src 'self' data: blob: https://aiagentsfirst.com",
      "font-src 'self' https://fonts.gstatic.com",
      "connect-src 'self' https://aiagentsfirst.com https://va.vercel-scripts.com",
      "frame-src 'self'",
      "object-src 'none'",
      "base-uri 'self'",
    ].join("; "),
